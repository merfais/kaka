...
import Retention from '../assets/retention-icon.svg';
import Delete from '../assets/delete-icon.svg';
import AddFilter from '../assets/add-filter-icon.svg';
import Bool from '../assets/bool-icon.svg';
import SortAsc from '../assets/sort-asc-icon.svg';
...
export const LogoIcon = () => <Icon component={Logo} />;
export const RetentionIcon = () => <Icon component={Retention} />;
export const DeleteIcon = () => <Icon component={Delete} />;
export const AddFilterIcon = () => <Icon component={AddFilter} />;
export const BoolIcon = () => <Icon component={Bool} />;
export const SortAscIcon = () => <Icon component={SortAsc} />;
